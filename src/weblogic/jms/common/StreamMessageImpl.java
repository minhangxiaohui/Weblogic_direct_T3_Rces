...
public final class StreamMessageImpl extends MessageImpl implements StreamMessage, Externalizable {
    ...
    public StreamMessageImpl(StreamMessage var1, Destination var2, Destination var3) throws IOException, JMSException {
        ...
        if (!(var1 instanceof weblogic.jms.common.StreamMessageImpl)) {
            var1.reset();
        }
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(1)) + var2);
            }
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(2)) + var2);
            }
        } catch (EOFException var3) {
            throw new weblogic.jms.common.MessageEOFException(this.readPastEnd(), var3);
        } catch (IOException var4) {
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(8)) + var2);
                case 8:
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(3)) + var2);
            }
        } catch (EOFException var3) {
            throw new weblogic.jms.common.MessageEOFException(this.readPastEnd(), var3);
        } catch (IOException var4) {
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(6)) + var2);
                case 6:
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(7)) + var2);
                case 6:
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(5)) + var2);
            }
        } catch (EOFException var3) {
            throw new weblogic.jms.common.MessageEOFException(this.readPastEnd(), var3);
        } catch (IOException var4) {
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(4)) + var2);
                case 9:
                case 10:
                    this.bdis.mark();
        ...
        try {
            switch (var1) {
                ...
                default:
                    ...
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), this.typeCodeToString(9)) + var2);
                case 12:
                    return null;
            }
        } catch (EOFException var3) {
            ...
            try {
                if (!this.readingByteArray) {
                    ...
                    if ((var2 = this.readType()) != 11) {
                        ...
                        this.bdis.unput();
                        throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var2), this.typeCodeToString(11)));
                    }
    ...
    public Object readObject() throws JMSException {
        ...
        try {
            switch (var1) {
                ...
                default:
                    this.bdis.unput();
                    throw new weblogic.jms.common.MessageFormatException(this.streamConversionError(this.typeCodeToString(var1), "Object"));
            }
        } catch (EOFException var5) {
            throw new weblogic.jms.common.MessageEOFException(this.readPastEnd(), var5);
        } catch (IOException var6) {
    ...
    public void writeObject(Object var1) throws JMSException {
        if (var1 instanceof Boolean) {
            ...
            if (var1 != null) {
                throw new weblogic.jms.common.MessageFormatException("Invalid Type: " + var1.getClass().getName());
            }
    ...
    public MessageImpl copy() throws JMSException {
        weblogic.jms.common.StreamMessageImpl var1 = new weblogic.jms.common.StreamMessageImpl();
        super.copy(var1);
        if (this.bdos != null) {
